        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Detail Kepengurusan</li>
            </ol>
          </div>
        </div>
    </div><!-- /.container-fluid -->
...
<?php foreach($kecamatan as $row) : ?>
    <?php $cekKecamatan = $this->Pac_model->getDataPacByIdKec($row['id_kec']); ?>
<?php endforeach; ?>
<?php if($cekKecamatan->num_rows() > 0) { ?>
    
<?php } else { ?>  
    <div class="container ml-2">
        <a href="<?= base_url('pac/tambah') ?>" class="btn btn-primary mb-3">+ Tambah Data</a>
    </div>
<?php } ?>
            ...
            <div class="card">
                ...
                <div class="card-body col-md-8 mx-auto">
                    <table id="example1" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th class="text-center" style="width: 10px;">Kolom</th>
      ...
      <div class="modal-body">
        <form action="<?= base_url('pac/tambah_kepengurusan_proses') ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="id_pac" value="<?= $row['id_pac']?>">
                <select class="form-control" disabled>
