        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card mb-3 mx-auto">
                    ...
                    <hr>
                    <div class="card-body">
                        <form method="post" action="<?= base_url('calon/dashboard/edit_proses/'.$keanggotaan['id_keanggotaan']) ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tempat_lahir" name="tempat_lahir" class="form-control" value="<?= $keanggotaan['tempat_lahir']?>" >
                            ...
                            <div class="form-group">
                                <label>No KTA</label><label class="text-danger text-lg">*</label>
                                <input type="text" name="no_kta" class="form-control" value="<?= $keanggotaan['no_kta']?>" >
...
<script>
        $(document).ready(function(){
            $("#wilayah_kab").change(function (){
                var url = "<?php echo site_url('calon/dashboard/getWilayahKecamatan');?>/"+$(this).val();
                $('#wilayah_kec').load(url);
                return false;
            })  

            $("#wilayah_kec").change(function (){
                var url = "<?php echo site_url('calon/dashboard/getWilayahDesa');?>/"+$(this).val();
