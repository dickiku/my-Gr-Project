            ...
            <div class="col-md-8">
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        ...
                        <form method="post" action="<?= base_url('badan_saksi/editPengurus_proses/'.$row['id_badan_saksi_kab'].'/'.'3') ?>" enctype="multipart/form-data">
                            <input type="hidden" name="temp" value="<?= $row['id_kab']?>">
