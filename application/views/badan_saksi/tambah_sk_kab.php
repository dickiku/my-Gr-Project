        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('badan_saksi/prosesTambahSk/'.'2') ?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Kabupaten / Kota</label>
                                <?php foreach($kabupaten as $kab): ?>
                                    <input type="hidden" name="temp" class="form-control" value="<?= $kab['id_kab'] ?>">
                                    <input type="text" name="" class="form-control" value="<?= $kab['nm_kab'] ?>" disabled>
                                <?php endforeach ?>
                            </div>
                            <div class="form-group">
