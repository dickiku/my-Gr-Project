        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('badan_saksi/prosesEditSk/'.'1') ?>" enctype="multipart/form-data">
                            <?php foreach($data as $row): ?>
                            <input type="hidden" name="id_data" value="<?= $row['id_badan_saksi_sk'] ?>">
                            <div class="form-group">
                                <label>Provinsi</label>
                                <input type="hidden" name="temp" class="form-control" value="<?= $row['id_prov'] ?>">
                                <input type="text" name="" class="form-control" value="Jawa Tengah" disabled>
                            </div>
                            <div class="form-group">
