        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('badan_saksi/prosesTambahSk/'.'3') ?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Kecamatan</label>
                                <?php foreach($kecamatan as $kec): ?>
                                    <input type="hidden" name="temp" class="form-control" value="<?= $kec['id_kec'] ?>">
                                    <input type="text" name="" class="form-control" value="<?= $kec['nm_kec'] ?>" disabled>
                                <?php endforeach ?>
                            </div>
                            <div class="form-group">
