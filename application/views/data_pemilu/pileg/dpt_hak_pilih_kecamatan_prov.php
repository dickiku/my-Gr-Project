                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('pileg/edit_pengguna_hak_pilih_kecamatan_prov/'). $row['id_jumlah_pemilih_pileg'] ?>" class="btn btn-warning btn-md">
                                        Edit
                                    </a>
                                </td>
                            </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('pileg/tambahDptKecamatanProv_proses') ?>" enctype="multipart/form-data">                             
