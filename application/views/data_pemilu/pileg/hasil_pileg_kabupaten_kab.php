                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if($user['level'] == 'Super Admin') : ?>
                                    <a href="<?= base_url('pileg/editHasilPilegKabupatenKab/'). $row['id_hasil_pileg'] ?>" class="btn btn-warning">Edit</a>
                                    <a href="<?= base_url('pileg/hapusHasilPilegKabupatenKab/'). $row['id_hasil_pileg'] ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">Hapus</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('pileg/tambah_hasil_pileg_kabupaten_kab_proses') ?>" enctype="multipart/form-data">
