                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('pilkada/pilgub_editHasilPilkadaKecamatan/'). $row['id_hasil_pilgub'].'/'.$row['id_kec'] ?>" class="btn btn-warning">Edit</a>
                                    <a href="<?= base_url('pilkada/pilgub_hapusHasilPilkadaKecamatan/'). $row['id_hasil_pilgub'].'/'.$row['id_kec'] ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">Hapus</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('pilkada/pilgub_tambahHasilPilgubKec_proses') ?>" enctype="multipart/form-data">
