            ...
            <div class="col-md-8">
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        ...
                        <form method="post" action="<?= base_url('pilkada/editPenggunaHakPilihKab_proses/') ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id_kab" class="form-control" value="<?= $row['id_kab'] ?>">
