                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('pilkada/pilbup_showhasilPerolehanDesa/'). $row['id_hasil_pilbup'].'/'.$row['id_desa'] ?>" class="btn btn-warning">Edit</a>
                                    <a href="<?= base_url('pilkada/pilbup_hapusHasilPilbupDesa/'). $row['id_hasil_pilbup'].'/'.$row['id_desa'] ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">Hapus</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('pilkada/pilbub_tambahHasilPerolehanDesa_proses') ?>" enctype="multipart/form-data">
