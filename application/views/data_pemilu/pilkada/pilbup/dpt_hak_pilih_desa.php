                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('pilkada/pilbup_showEditDptDesa/'). $row['id_jumlah_pemilih_pilkada'] ?>" class="btn btn-warning btn-md">
                                        Edit
                                    </a>
                                </td>
                            </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('pilkada/pilbup_tambahDptDesa_proses') ?>" enctype="multipart/form-data">                             
