                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if($user['level'] == 'Super Admin') : ?>
                                    <a href="<?= base_url('pilpres/editHasilPilpresKabupaten/'). $row['id_hasil_pilpres'] ?>" class="btn btn-warning">Edit</a>
                                    <a href="<?= base_url('pilpres/hapusHasilPilpresKabupaten/'). $row['id_hasil_pilpres'] ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">Hapus</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('pilpres/tambah_hasil_pilpres_kabupaten_proses') ?>" enctype="multipart/form-data">
