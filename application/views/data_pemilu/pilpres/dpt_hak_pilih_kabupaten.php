                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('pilpres/edit_pengguna_hak_pilih_kabupaten/'). $row['id_jumlah_pemilih'] ?>" class="btn btn-warning btn-md">
                                        Edit
                                    </a>
                                </td>
                            </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('pilpres/tambahDptKabupaten_proses') ?>" enctype="multipart/form-data">                             
