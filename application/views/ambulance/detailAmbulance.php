                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <?php if($user['level'] == 'Super Admin') : ?>
                                        <a href="<?= base_url('ambulance/detailKabupaten/'). $row['id_ambulance'] ?>" class="btn btn-success">Detail</a>
                                        <a href="<?= base_url('ambulance/editKabupaten/'). $row['id_ambulance'] ?>" class="btn btn-warning">Edit</a>
                                        <a href="<?= base_url('ambulance/hapusAmbulanceKabupaten/'). $row['id_ambulance'] ?>" class="btn btn-danger" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">Hapus</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('ambulance/tambahAmbulanceKabupaten') ?>" enctype="multipart/form-data">
            <?php foreach($wilayah as $w) : ?>
            <div class="form-group">
                <label>Kabupaten/Kota</label>
                <input type="hidden" class="form-control" name="id_kab" value="<?= $w['id_kab'] ?>">
