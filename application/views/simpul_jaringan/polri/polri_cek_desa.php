                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if($user['level'] == 'Super Admin') : ?>
                                        <a href="<?= base_url('simpul_jaringan/editPolriDesa/'). $row->id_polri ?>" class="btn btn-warning btn-md">
                                            Edit
                                        </a>
                                        <a href="<?= base_url('simpul_jaringan/hapusPolriDesa/'). $row->id_polri ?>" class="btn btn-danger btn-md" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">
                                            Hapus
                                        </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('simpul_jaringan/tambah_polri_desa') ?>" method="post">
