        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit KPU</li>
            </ol>
          </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md-8">
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        ...
                        <form method="post" action="<?= base_url('simpul_jaringan/editKpu_proses_kecamatan/'.$row['id_kpu']) ?>" enctype="multipart/form-data">
