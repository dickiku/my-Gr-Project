                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if($user['level'] == 'Super Admin') : ?>
                                        <a href="<?= base_url('simpul_jaringan/editTogaTomasProvinsi/'). $row->id_toga_tomas ?>" class="btn btn-warning btn-md">
                                            Edit
                                        </a>
                                        <a href="<?= base_url('simpul_jaringan/hapusTogaTomasProvinsi/'). $row->id_toga_tomas ?>" class="btn btn-danger btn-md" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">
                                            Hapus
                                        </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('simpul_jaringan/tambah_toga_tomas_provinsi') ?>" method="post">
