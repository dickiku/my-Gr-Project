        ...
        <div class="row">
            ...
            <?= $this->session->flashdata('pesan'); ?>
                <div class="card mb-3 mx-auto">
                    ...
                    <hr>
                    <div class="card-body">
                        <form method="post" action="<?= base_url('sayap_partai/tambahDomSayapPartaiProv_proses') ?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Wilayah</label>
                                <input type="hidden" class="form-control" name="id_prov" value=33 readonly>
                                <input type="text" class="form-control" value="Sayap Partai Provinsi" disabled>
                            </div>
