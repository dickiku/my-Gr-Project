            ...
            <div class="col-md-8">
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        ...
                        <form method="post" action="<?= base_url('sayap_partai/editKepengurusan_proses_kabupaten/'.$row['id_pengurus_sayap_partai']) ?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Kolom</label>
                                <input type="text" name="kolom" class="form-control" value="<?= $row['kolom'] ?>">
                            </div>
                            <div class="form-group">
                                <label>Nama</label>
