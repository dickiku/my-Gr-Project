        ...
        <div class="row">
            ...
            <?= $this->session->flashdata('pesan'); ?>
                <div class="card mb-3 mx-auto">
                    ...
                    <hr>
                    <div class="card-body">
                        <form method="post" action="<?= base_url('sayap_partai/tambahDomSayapPartaiKec_proses') ?>" enctype="multipart/form-data">
                            <?php foreach($wilayah as $w) : ?>
                            <div class="form-group">
                                <label>Wilayah</label>
                                <input type="hidden" class="form-control" name="id_kec" value="<?= $w['id_kec']?>" readonly>
                                <input type="text" class="form-control" value="Sayap Partai <?= $w['nm_kec']?>" disabled>
                            </div>
                            <?php endforeach; ?>
