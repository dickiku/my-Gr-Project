                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if($user['level'] == 'Super Admin') : ?>
                                    <a href="<?= base_url('gmd/editKepengurusanProvinsi/').$kp['id_pengurus_gmd'] ?>" class="btn btn-warning btn-md">
                                        Edit
                                    </a>
                                    <a href="<?= base_url('gmd/hapusKepengurusanProvinsi/').$kp['id_pengurus_gmd'] ?>" class="btn btn-danger btn-md" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">
                                        Hapus
                                    </a>
      ...
      <div class="modal-body">
        <form action="<?= base_url('gmd/tambah_kepengurusan_proses_provinsi') ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="id_angkatan" value="<?= $a['id_angkatan']?>" class="form-control">
                <input type="text" value="<?= $a['nama_angkatan']?>" class="form-control" disabled>
                <?php endforeach; ?>
            </div>
            <div class="form-group">
