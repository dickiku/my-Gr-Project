<div class="col-lg-4">
   <div class="right_sidebar">
      ...
      <aside class="r_widgets social_widgets mt-5">
         ...
         <ul class="list">
            <li><a href="#"><i class="fa fa-facebook"></i>Dpdgerindra.org<span>Like our page</span></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i>Dpdgerindra.org<span>Follow Us</span></a></li>
            <li><a href="#"><i class="fa fa-youtube-play"></i>Dpdgerindra.org<span>Subscribe</span></a></li>
         </ul>
      </aside>
