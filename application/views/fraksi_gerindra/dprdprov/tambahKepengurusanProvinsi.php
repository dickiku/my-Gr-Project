        ...
        <div class="row">
            ...
            <?= $this->session->flashdata('pesan'); ?>
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('fraksi_gerindra/tambah_proses_provinsi') ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Jabatan Fraksi</label><label class="text-danger text-lg">*</label>
                            ...
                            <div class="form-group">
                                <label>Jabatan AKD</label><label class="text-danger text-lg">*</label>
                            ...
                            <div class="form-group">
                                <label>Jabatan AKD Lain</label><label class="text-danger text-lg">*</label>
