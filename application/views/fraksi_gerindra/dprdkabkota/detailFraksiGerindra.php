                ...
                <div class="card mb-3 mx-auto">
                    <div class="card-body">
                        <?php foreach($data as $row) : ?>
                            <a href="<?= base_url('fraksi_gerindra/editKabupaten/').$row['id_fraksi_gerindra'] ?>" class="btn btn-lg btn-warning mb-2">Edit</a>
                        <?php endforeach; ?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Susunan Kepengurusan Fraksi Gerindra Kab/Kota</h3>
                </div>
                        ...
                        <?php $no=1; foreach($kepengurusan as $kp) : ?>
                            <tr>
                                ...
                                <?php if($user['level'] == 'Super Admin') : ?>
                                    <a href="<?= base_url('fraksi_gerindra/editKepengurusanKabupaten/').$kp['id_pengurus_fraksi_gerindra'] ?>" class="btn btn-warning btn-md">
                                        Edit
                                    </a>
                                    <a href="<?= base_url('fraksi_gerindra/hapusKepengurusanKabupaten/').$kp['id_pengurus_fraksi_gerindra'] ?>" class="btn btn-danger btn-md" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">
                                        Hapus
                                    </a>
