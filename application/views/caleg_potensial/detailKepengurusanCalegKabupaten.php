                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <?php if($user['level'] == 'Super Admin') : ?>
                                ...
                                <td><?= $row['no_hp'] ?></td>
                                <td>
                                    <a href="<?= base_url('caleg_potensial/hapusDataKepengurusanCalegKabupaten/').$row['id_caleg_potensial'] ?>" class="btn btn-danger btn-md" onclick="return confirm('Apakah yakin anda ingin menghapus data ini?')">
                                        Hapus
                                    </a>
                                </td>
                            <?php elseif($user['level'] == 'Admin' ) : ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('caleg_potensial/tambahCalegPotensial_proses_kabupaten') ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="id_dapil_kab" class="form-control" value="<?= $row['id_dapil_kab']?>">
                <input type="text" class="form-control" value="<?= $row['nama_dapil_kab']?>" disabled>
                <?php endforeach; ?>
            </div>
            <div class="form-group">
